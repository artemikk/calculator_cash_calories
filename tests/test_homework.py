...
class TestCalculator:
    ...
    def test_init(self, init_limit, msg_err):
        assert hasattr(main, 'Calculator'), msg_err('add_class', 'Calculator')
        result = main.Calculator(init_limit)
...
class TestCashCalculator:
    ...
    def test_get_today_cash(self, init_limit, data_records, amount, currency, today_cash_remained, msg_err,
                            monkeypatch):
        result = main.CashCalculator(init_limit)
        assert hasattr(result, 'get_today_cash'), \
            msg_err('add_method', 'get_today_cash', 'CashCalculator')
        ...
        assert re.fullmatch(today_cash_remained(amount, currency), result.get_today_cash(currency)), \
            msg_err('wrong_method', 'get_today_cash', 'CashCalculator')
